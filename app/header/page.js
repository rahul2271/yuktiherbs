...
export default function Header(){
    ...
    return(
      ...
      <img className=' mx-auto  relative  h-[60px] w-[255px] md:h-[70px] md:w-[300px] md:mt-[90px] md:mx-[10px]' src="./logo.png" alt="rchauhan" />
          <ul className='mt-[20px] md:mt-[-50px]  flex   md:text-xl  md:place-content-center lg:flex md:space-x-6 lg:place-content-center text-[12px] text-[#2C3753] space-x-6  place-content-center text-[12px] font-bold'>
