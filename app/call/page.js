...
const CallNowButton = () => {
  ...
  return (
    <div className="mt-[-20px] flex items-center justify-center gap-x-2">
              <button
                type="button"
                className=" shadow-lg shadow-black/50 rounded-[20px] bg-[#ffdd00] border- border-black px-[60px] py-2 md:px-[80px] md:py-[10px] text-sm md:text-[18px] font-semibold text-black shadow-md hover:bg-[#ffdd00]/50 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black"
