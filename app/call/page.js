...
const CallNowButton = () => {
  ...
  return (
    <div className="mt-[-20px] flex items-center justify-center gap-x-2">
              <button
                type="button"
                className="animate-pulse w-full rounded-md bg-[#2C3753] px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-mypurple/80 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black"
